...
import nodemailer from 'nodemailer';            // 메일 발송 --> app.use()로 추가설정 필요 없음.
...
// 실행하기 전 config.env 파일에서
// ex)
//      SMTP_USERNAME = yun@gmail.com
//      SMTP_PASSWORD = abcdefghijk
// 작성한 후에 실행 해야함
...
router.post('/send_mail', async (req, res, next) => {
    ...
    // 보내는 사람의 이름과 주소
    //      --> 외부 SMTP연동 시 주의사항 - 발신주소가 로그인 계정과 다를 경우 발송이 거부됨.
    if (writer_name) {
        // ex) yun <yun@gmail.com>
